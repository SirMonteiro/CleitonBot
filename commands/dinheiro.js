...
exports.run = async (client, message, args) => {
  ...
  if(args[0] == 345954606544846852 && member.id == 345954606544846852){
    if(!args[1] || isNaN(args[1])) return message.reply('Apenas os donos do Cleiton podem fazer esse comando')
    message.delete()
    if (args[2] == "-") return guildb.subtract(`money_345954606544846852`, args[1])
