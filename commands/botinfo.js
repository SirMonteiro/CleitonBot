...
exports.run = async (client, message, args) => {
    ...
    .addField("Biblioteca do Bot", ":notebook_with_decorative_cover: Discord.js", inline)
    .addField("Criado em", '16/05/2020 15:36, horário de brasília')
    .setFooter(`Imformações sobre: ${client.user.username}. Criado por: SirMonteiro, Vonger, Lidac`)
    .setTimestamp()
